...
constexpr static __CD_U32 __Cd_np_##__Name##_seed = 1776 + __LINE__ + __TIME__[7] + __TIME__[6] + __TIME__[4];													\
...
0x48, 0xB8, (0xFFull << 0x38) & __Cd_np_##__Name##_seed, (0xFFull << 0x30) & __Cd_np_##__Name##_seed, (0xFFull << 0x38)& __Cd_np_##__Name##_seed, (0xFFull << 0x20)& __Cd_np_##__Name##_seed, (0xFFull << 0x18)& __Cd_np_##__Name##_seed, (0xFFull << 0x10)& __Cd_np_##__Name##_seed, (0xFFull << 0x8)& __Cd_np_##__Name##_seed, (0xFFull << 0x0)& __Cd_np_##__Name##_seed,  \
